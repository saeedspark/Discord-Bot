...
@bot.event
async def on_ready():
    welcome_channel = bot.get_channel(1187365620279427072)
    verify_channel = bot.get_channel(1199714429021978624)
    rules_channel = bot.get_channel(1187360762625261609)
    get_start_channel = bot.get_channel(1187365733680820245)
